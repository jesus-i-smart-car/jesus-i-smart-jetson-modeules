...
#define LIDAR_Wall_Detection 0.35
...
void CarControlCallback(const geometry_msgs::Twist& msg)
{
  //ROS_INFO("I heard: [%s]", msg->data.c_str());
   ...
   steering_angle = (int)(-msg.angular.z*80+STEER_NEUTRAL_ANGLE) ;
  
   
   if(steering_angle >= 50+STEER_NEUTRAL_ANGLE)  steering_angle = STEER_NEUTRAL_ANGLE+50;
   if(steering_angle <=-50+STEER_NEUTRAL_ANGLE)  steering_angle = STEER_NEUTRAL_ANGLE-50;
   
   Base_Speed  = (int)(msg.linear.x*70);
  ...
  /*
    ...
    */
    ...
    for(int i = 0; i < count; i++)
    {
        ...
        if(((degree>=240-15)&&(degree<=240+15)))
        {
        ...
        if(((degree>=260-15)&&(degree<=260+15)))
        {
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub1 = n.subscribe("/cmd_vel/xbox360", 10, &CarControlCallback);
